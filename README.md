...
7. **שלב 3** - קצת יותר קל ורגוע משלב 2 על מנת לגרום לשחקן להצליח במשחק ולרצות לשחק, בוא יש 5 כפתורים אך רק לחיצה על 2 מהם תפתח את השער, המטרה לגלות איזה מהשניים יפת את הדלת רמז? הכי שמאלי וכמעט הכי ימני)
8. **שלב 4** - מחזירים את הקושי בשלב זה נוצרים 2 שכפולים עכשיו התיאום צריך להיות יותר גבוה כמובן יש גם אויביים בשלב (הערה שכפולים יכולים לגעת אחד בשני)
