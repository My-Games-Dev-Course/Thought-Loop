...
**Thought Loop** הוא משחק פאזל-פלטפורמר 2D שבו אתה הופך לשותף של עצמך.
...
- מקליט מיקום (position), סיבוב (rotation) וגודל (scale) בכל פריים  
- מקליט מצבי אנימציה (ריצה/עמידה)  
- מקליט היפוך ספרייט (flipX)  
- שומר את כל הנתונים ברשימות (Lists) לשימוש מאוחר יותר
